"""
Stage Jobs Workday Asset

Individual platform asset for Workday jobs processing.
Part of ENHANCEMENT-001: Asset Breakdown Strategy for parallel processing.

This asset:
1. Loads Workday RAW data
...
class StageWorkdayConfig(Config):
    """Configuration for Workday stage processing."""
...
@asset(
    ...
    description="Processed Workday jobs data loaded to STAGE.jobs_unified"
)
def stage_jobs_workday(context: AssetExecutionContext, config: StageWorkdayConfig) -> Dict[str, Any]:
    """
    Process Workday jobs data through complete transformation pipeline.
