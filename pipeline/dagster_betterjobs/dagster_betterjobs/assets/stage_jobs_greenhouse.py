"""
Stage Jobs Greenhouse Asset

Individual platform asset for Greenhouse jobs processing.
Part of ENHANCEMENT-001: Asset Breakdown Strategy for parallel processing.

This asset:
1. Loads Greenhouse RAW data
...
class StageGreenhouseConfig(Config):
    """Configuration for Greenhouse stage processing."""
...
@asset(
    ...
    description="Processed Greenhouse jobs data loaded to STAGE.jobs_unified"
)
def stage_jobs_greenhouse(context: AssetExecutionContext, config: StageGreenhouseConfig) -> Dict[str, Any]:
    """
    Process Greenhouse jobs data through complete transformation pipeline.
