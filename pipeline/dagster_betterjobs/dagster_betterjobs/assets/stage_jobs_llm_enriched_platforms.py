"""
Platform LLM Enrichment Asset

Platform-specific LLM enrichment for jobs using shared processing logic.
Part of ENHANCEMENT-031: Company-based partitioned LLM enrichment for parallel processing.

This asset processes jobs partitioned by company name (A-Z, 0-9, other)
