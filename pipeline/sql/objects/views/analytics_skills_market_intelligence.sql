CREATE VIEW IF NOT EXISTS ANALYTICS.SKILLS_MARKET_INTELLIGENCE AS
WITH SKILL_DEMAND_TRENDS AS (
    ...
    JOIN ANALYTICS.JOB_SKILLS_BRIDGE JSB ON F.JOB_POSTING_KEY = JSB.JOB_POSTING_KEY
    JOIN ANALYTICS.DIM_SKILLS S ON JSB.SKILL_KEY = S.SKILL_KEY
    ...
    WHERE D.FULL_DATE >= CURRENT_DATE - 90
      ...
      AND JSB.EXTRACTION_CONFIDENCE >= 0.7
